...
void RB_FGL_DrawInteraction(const drawInteraction_t* din)
{
}

void RB_FGL_CreateDrawInteractions(const drawSurf_t* surf)
{

}

void RB_FGL_DrawInteractions()
{
